...
--    2. Archivo → Open SQL Script → selecciona este archivo
--    3. Ctrl+Shift+Enter  (ejecutar todo)
--    O pega todo en el Query Editor y ejecuta.
--
--  Incluye:
--    • Estructura completa de todas las tablas
--    • Datos iniciales (seed) con el contenido actual de cada módulo
-- ================================================================
...
INSERT INTO `configuracion` (`clave`, `valor`, `descripcion`) VALUES
  ...
  ('maps_embed_url',       'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3733.5!2d-103.1901!3d20.2985!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842f4f1f7c6e5555%3A0x0!2sTecnol%C3%B3gico+Superior+de+Jalisco%2C+Chapala!5e0!3m2!1ses!2smx!4v1700000000000', 'URL del iframe de Google Maps'),
  ('maps_link_url',        'https://maps.app.goo.gl/w3rApmQrocT3j5V88', 'Enlace directo a Google Maps');


-- ================================================================
-- 2. CARRERAS  (compartida por todos los módulos)
-- ================================================================
...
INSERT INTO `carreras` (`clave`, `nombre`, `orden`) VALUES
  ('ISC',   'Ingeniería en Sistemas Computacionales',          1),
  ('II',    'Ingeniería Industrial',                           2),
  ('IM',    'Ingeniería Mecatrónica',                          3),
  ('IADEV', 'Ingeniería en Animación Digital y Efectos Visuales', 4),
  ('IGE',   'Ingeniería en Gestión Empresarial',               5),
  ('LG',    'Gastronomía',                                     6);
...
-- 3.4 Materias por carrera (plan de estudios)
...
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  ...
  (1,'Bases de Datos',                    3),
  (1,'Redes de Computadoras',             4),
  (1,'Sistemas Operativos',               5),
  (1,'Ingeniería de Software',            6),
  (1,'Análisis de Sistemas',              7),
  (1,'Arquitectura de Computadoras',      8),
  (1,'Desarrollo Web',                    9),
  (1,'Programación Orientada a Objetos', 10);

-- II
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  (2,'Fundamentos de Ingeniería Industrial', 1),
  (2,'Procesos de Manufactura',              2),
  (2,'Control de Calidad',                   3),
  (2,'Ergonomía y Seguridad Industrial',     4),
  (2,'Administración de Operaciones',        5),
  (2,'Logística y Cadena de Suministro',     6),
  (2,'Estadística Aplicada',                 7),
  (2,'Simulación de Sistemas',               8),
  (2,'Diseño de Plantas Industriales',       9),
  (2,'Gestión de Proyectos',                10);

-- IM
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  (3,'Fundamentos de Mecatrónica',    1),
  (3,'Electrónica Analógica',         2),
  (3,'Electrónica Digital',           3),
  (3,'Sistemas de Control',           4),
  (3,'Robótica',                      5),
  (3,'Programación de PLCs',          6),
  (3,'Neumática e Hidráulica',        7),
  (3,'Instrumentación',               8),
  (3,'Diseño Mecánico',               9),
  (3,'Automatización Industrial',    10);

-- IADEV
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  (4,'Fundamentos del Diseño Digital',          1),
  (4,'Animación 2D',                             2),
  (4,'Animación 3D',                             3),
  (4,'Diseño de Personajes',                     4),
  (4,'Efectos Visuales (VFX)',                   5),
  (4,'Composición Digital',                      6),
  (4,'Guión y Storyboard',                       7),
  (4,'Post-producción de Video',                 8),
  (4,'Realidad Virtual y Aumentada',             9),
  (4,'Producción Audiovisual',                  10);

-- IGE
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  (5,'Administración de Empresas',           1),
  (5,'Contabilidad Financiera',              2),
  (5,'Economía',                             3),
  (5,'Gestión del Talento Humano',           4),
  (5,'Marketing',                            5),
  (5,'Finanzas Empresariales',               6),
  (5,'Emprendimiento e Innovación',          7),
  (5,'Gestión de Proyectos',                 8),
  (5,'Comportamiento Organizacional',        9),
  (5,'Planeación Estratégica',              10);

-- LG
INSERT INTO `materias` (`carrera_id`, `nombre`, `orden`) VALUES
  (6,'Fundamentos de Cocina',              1),
  (6,'Higiene y Seguridad Alimentaria',    2),
  (6,'Cocina Internacional',               3),
  (6,'Panadería y Repostería',             4),
  (6,'Nutrición y Dietética',              5),
  (6,'Enología y Bebidas',                 6),
  (6,'Gestión de Alimentos y Bebidas',     7),
  (6,'Cocina Molecular',                   8),
  (6,'Arte Culinario y Presentación',      9),
  (6,'Costos y Presupuestos en Cocina',   10);


-- 3.5 Personal administrativo (secretarías)
...
-- 3.6 Configuración de nuevo ingreso
...
-- Datos de ejemplo (reemplazar con los convenios reales)
INSERT INTO `convenios` (`carrera_id`, `nombre`, `tipo_convenio`, `nombre_contacto`, `correo_contacto`, `vencimiento`) VALUES
  (4, 'Empresa Tecnológica S.A.',   'residencia',    'Carlos Mendoza', 'cmendoza@empresa.com',    '2025-12-31'),
  (4, 'Estudio Creativo MX',        'servicio_social','Ana Torres',    'ana.torres@estudio.mx',   '2025-06-30'),
  (2, 'Industrias del Bajío S.A.',  'practicas',     'Roberto Sánchez','rsanchez@industrias.com', '2025-08-15');
...
CREATE TABLE `horarios` (
  ...
  `semestre`        VARCHAR(10),
  `imagen_horario`  VARCHAR(500)  COMMENT 'Ruta a PDF o imagen del horario',
  `activo`          TINYINT(1)    NOT NULL DEFAULT 1,
  `created_at`      TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at`      TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- ================================================================
-- 7. REQUISITOS  (Residencia Profesional y Servicio Social)
-- ================================================================

-- 7.1 Checklist de requisitos
...
-- 7.2 Fases del proceso (timeline)
...
-- ================================================================
-- 8. REDES SOCIALES (tabla separada para facilitar edición)
-- ================================================================
...
-- ================================================================
-- VISTAS ÚTILES (opcionales, facilitan las queries del backend)
-- ================================================================

-- Vista: docentes con nombre de carrera
...
-- Vista: convenios con nombre de carrera
CREATE VIEW `v_convenios` AS
  SELECT cv.id, cv.nombre, cv.tipo_convenio, cv.nombre_contacto,
         cv.correo_contacto, cv.telefono_contacto, cv.logo,
         cv.vencimiento, cv.activo,
         c.id AS carrera_id, c.clave AS carrera_clave, c.nombre AS carrera_nombre
  FROM `convenios` cv
  LEFT JOIN `carreras` c ON cv.carrera_id = c.id;

-- Vista: horarios con nombre de profesor y carrera
...
-- Vista: materias con nombre de carrera
...
-- Vista: coordinadores con nombre de carrera
...
-- ================================================================
-- ¡Listo! Base de datos kiosko_tsj creada correctamente.
--
-- Tablas creadas (17):
...
--
-- Siguiente paso:
--   Actualizar shared/config.php → DB_UNIFIED = 'kiosko_tsj'
--   y migrar las queries de cada módulo a esta BD.
-- ================================================================
