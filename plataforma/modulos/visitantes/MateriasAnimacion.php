...
$tsj_title      = 'Materias de Animación';
...
$tsj_head_extra = '<style>
    body {
      ...
      background: linear-gradient(135deg, #8e44ad, #9b59b6); /* Degradado morado */
      color: white;
      display: flex;
    ...
    td input:focus {
      border: 1px solid #e74c3c; /* Rojo cuando está enfocado */
    }
...
"Postproducción y Efectos Visuales (VFX)",
"Motion Graphics"
