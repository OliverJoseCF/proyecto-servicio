...
.portal-card:focus-visible .portal-card-arrow {
    opacity: 1;
    transform: translateX(0);
}
/* Mostrar flecha siempre en táctil (sin hover) */
@media (hover: none) {
    .portal-card-arrow { opacity: 1; transform: translateX(0); }
}
.portal-card-arrow svg {
    width: 14px; height: 14px;
    stroke: var(--tsj-blue); fill: none;
  ...
  <div class="portal-section">
    ...
    <div class="portal-grid">
      ...
      <a href="<?= $base ?>/modulos/biblioteca/buscar.php" class="portal-card">
        <div class="portal-card-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" width="24" height="24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
        </div>
        <div class="portal-card-body">
          <h2>Biblioteca</h2>
      ...
      <a href="<?= $base ?>/modulos/convenios/index.php" class="portal-card">
        <div class="portal-card-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" width="24" height="24"><path d="M9 14l-4-4 4-4"/><path d="M5 10h11a4 4 0 0 1 0 8h-1"/></svg>
        </div>
        <div class="portal-card-body">
          <h2>Convenios</h2>
      ...
      <a href="<?= $base ?>/modulos/horarios/index.php" class="portal-card">
        <div class="portal-card-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" width="24" height="24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        </div>
        <div class="portal-card-body">
          <h2>Horarios</h2>
      ...
      <a href="<?= $base ?>/modulos/requisitos/residencia.php" class="portal-card">
        <div class="portal-card-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" width="24" height="24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
        </div>
        <div class="portal-card-body">
          <h2>Requisitos</h2>
