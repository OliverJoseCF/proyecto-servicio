...
<head>
    ...
    <title>Maestros y Horarios — TSJ Chapala</title>
...
<body>
    ...
    <nav class="toolbar">
        ...
        <div class="toolbar-right">
            ...
            <a class="text-login texto-inter" href="login.php">Iniciar Sesión</a>
        </div>

        <button class="menu-button" id="menuBtn" aria-label="Menú">
            <img src="Imagenes/menu.svg" alt="Menú" id="menuIcon">
        </button>
    </nav>
    ...
    <div class="menu-panel" id="menuPanel">
        <div class="menu-content">
            <a class="menu-item" href="../../index.html">← Página principal</a>
            <a class="menu-item" href="login.php">Iniciar Sesión (Admin)</a>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-img">
                <img src="Imagenes/logoblacno.svg" alt="Logo TSJ">
            </div>
            <div class="footer-links">
                <div class="footer-img">
                    <a href="https://www.facebook.com/TecSJ" target="_blank" rel="noopener" aria-label="Facebook">
                        <img src="Imagenes/face.svg" alt="Facebook">
                    </a>
                </div>
                <div class="footer-img">
                    <a href="https://www.youtube.com/@TecSJ" target="_blank" rel="noopener" aria-label="YouTube">
                        <img src="Imagenes/youtube.svg" alt="YouTube">
                    </a>
                </div>
            </div>
            <div class="footer-text-links">
                <a class="footer-link" href="../../proyecto-web-main/index.php">Modulo de convenios</a>
                <a class="footer-link"
                   ...
                   target="_blank" rel="noopener">Plataforma Nacional de Transparencia</a>
            </div>
        </div>
    </footer>
    ...
    <div class="extra-info">
        <div class="additional-images">
            <img src="Imagenes/logos2.png" alt="Logos institucionales">
        </div>
    </div>
    ...
    menuBtn?.addEventListener('click', () => {
        const open = menuPanel.classList.toggle('active');
        menuBtn.classList.toggle('active', open);
        if (menuIcon) menuIcon.src = open ? 'Imagenes/close.svg' : 'Imagenes/menu.svg';
    });
    document.addEventListener('click', e => {
        if (!menuPanel.contains(e.target) && !menuBtn.contains(e.target)) {
            menuPanel.classList.remove('active');
            menuBtn.classList.remove('active');
            if (menuIcon) menuIcon.src = 'Imagenes/menu.svg';
        }
    });
    </script>
</body>
