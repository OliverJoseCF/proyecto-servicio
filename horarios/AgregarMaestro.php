...
<head>
    ...
    <link rel="stylesheet" href="css/agregarMaestro.css">
</head>
<body>
    <div class="barrarosa"></div>

    <section class="fondomorado">
        <div class="logo-container">
            <img src="Imagenes/logoblacno.svg" alt="Logo TSJ" width="220">
        </div>
        <div>
            <img src="Imagenes/logos2.png" alt="Logos institucionales" width="420">
        </div>
    </section>
